...
const GATE12_SAFE_MESSAGES = Object.freeze({
  ...
  FIXTURE_PARK_FAILED: "Controlled smoke park fixture setup failed.",
  FIXTURE_SOURCE_FAILED: "Controlled smoke source fixture setup failed.",
  FIXTURE_CAPABILITY_FAILED: "Controlled smoke capability fixture setup failed.",
  FIXTURE_NAMESPACE_FAILED: "Controlled smoke namespace fixture setup failed.",
  FIXTURE_EXPERIENCE_FAILED: "Controlled smoke experience fixture setup failed.",
  FIXTURE_ALIAS_FAILED: "Controlled smoke alias fixture setup failed.",
