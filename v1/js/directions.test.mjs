...
test('accepts a specific venue at a trusted Disney resort', () => assert.equal(resolveDirectionsDestination({title: 'Topolino’s Terrace', location: 'Disney’s Riviera Resort'}), 'Topolino’s Terrace'));
